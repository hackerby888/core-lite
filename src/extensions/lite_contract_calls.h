...
// REGISTER_USER_*; the liteCall*/liteInvoke* helpers are defined in lite_dyn_abi.h (.so) / lite_wasm_tu.h (wasm).
#if defined(LITE_DYN_SO_BUILD) || defined(LITE_WASM_TU_BUILD)

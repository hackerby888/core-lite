...
{
    return (offset + CONTRACT_INVOCATION_BUFFER_ALIGNMENT - 1)
        & ~(CONTRACT_INVOCATION_BUFFER_ALIGNMENT - 1);
}

constexpr ContractInvocationBufferLayout contractInvocationBufferLayout(

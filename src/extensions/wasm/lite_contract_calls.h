...
// (contractUserFunctions/Procedures tables), instead of inlining the callee. Included by the wasm
// contract wrapper AFTER contracts/qpi.h and the qinit-generated per-fn inputType constants, BEFORE the
// user contract. The `<Type>_<fn>_inputType` constants are generated by qinit from each callee's
// REGISTER_USER_*; the liteCall*/liteInvoke* helpers are defined in lite_wasm_tu.h.
